...
class DIN(nn.Module):
    def __init__(self, in_channels, out_channels, num_features, growthrate, upscale_factor):
        ...
        self.conv_out = nn.Conv2d(num_features * 4, num_features, 1, padding=0, stride=1)

        self.up_recon = Upsampler(num_features, out_channels, kSize, scale)
    ...
    def forward(self, x):
        ...
        # stage 2
        pro_recon2_1 = self.AsyCA2_1(WRDB1_1, WRDB1_1)
        WRDB2_1 = self.WRDB2_1(pro_recon2_1)
        pro_recon2_2 = self.AsyCA2_2(WRDB1_2, WRDB2_1)
        WRDB2_2 = self.WRDB2_2(pro_recon2_2)
        pro_recon2_3 = self.AsyCA2_3(WRDB1_3, WRDB2_2)
        WRDB2_3 = self.WRDB2_3(pro_recon2_3)
        pro_recon2_4 = self.AsyCA2_4(WRDB1_4, WRDB2_3)
        WRDB2_4 = self.WRDB2_4(pro_recon2_4)
        pro_recon2_5 = self.AsyCA2_5(WRDB1_5, WRDB2_4)
        WRDB2_5 = self.WRDB2_5(pro_recon2_5)

        # stage 3
        pro_recon3_1 = self.AsyCA3_1(WRDB2_1, WRDB2_1)
        WRDB3_1 = self.WRDB3_1(pro_recon3_1)
        pro_recon3_2 = self.AsyCA3_2(WRDB2_2, WRDB3_1)
        WRDB3_2 = self.WRDB3_2(pro_recon3_2)
        pro_recon3_3 = self.AsyCA3_3(WRDB2_3, WRDB3_2)
        WRDB3_3 = self.WRDB3_3(pro_recon3_3)
        pro_recon3_4 = self.AsyCA3_4(WRDB2_4, WRDB3_3)
        WRDB3_4 = self.WRDB3_4(pro_recon3_4)
        pro_recon3_5 = self.AsyCA3_5(WRDB2_5, WRDB3_4)
        WRDB3_5 = self.WRDB3_5(pro_recon3_5)

        # stage 4
        pro_recon4_1 = self.AsyCA4_1(WRDB3_1, WRDB3_1)
        WRDB4_1 = self.WRDB4_1(pro_recon4_1)
        pro_recon4_2 = self.AsyCA4_2(WRDB3_2, WRDB4_1)
        WRDB4_2 = self.WRDB4_2(pro_recon4_2)
        pro_recon4_3 = self.AsyCA4_3(WRDB3_3, WRDB4_2)
        WRDB4_3 = self.WRDB4_3(pro_recon4_3)
        pro_recon4_4 = self.AsyCA4_4(WRDB3_4, WRDB4_3)
        WRDB4_4 = self.WRDB4_4(pro_recon4_4)   
        pro_recon4_5 = self.AsyCA4_5(WRDB3_5, WRDB4_4)
        WRDB4_5 = self.WRDB4_5(pro_recon4_5)

        out = torch.cat((WRDB1_5, WRDB2_5, WRDB3_5, WRDB4_5), 1)
        out = self.conv_out(self.act(out))
        Out = f_in + out

        sr_out = self.up_recon(Out)
